  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <section className="hero" id="inicio">
        ...
        {interactiveRobot&&<div className="hero-robot" aria-label="Robot interactivo de Solventech">
