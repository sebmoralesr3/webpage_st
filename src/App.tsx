...
function App() {
  ...
  const handleContactSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      trackEvent('generate_lead', { form_name: 'contacto', contact_type: contactType })
    } catch {
      setFormStatus('error')
    }
  }
