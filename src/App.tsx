...
function App() {
  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <section className="services" id="servicios"><div className="section-heading"><SectionTitle>Servicios</SectionTitle><p>Soluciones digitales en Diseño, Desarrollo Web y Transformación Tecnológica.</p></div><div className="service-grid">
        <article className="service-card light"><h3>Desarrollo a la medida</h3><p>Diseñamos y desarrollamos soluciones tecnológicas personalizadas que responden a los desafíos de cada organización, creando herramientas funcionales, escalables y alineadas con sus objetivos de transformación.</p><a href="#contacto"><Arrow/>Conocer más</a></article>
        <article className="service-card dark"><h3>Identidad de marca</h3><p>Construimos identidades de marca sólidas y coherentes que reflejan la esencia de cada organización, integrando estrategia e identidad visual para fortalecer una marca auténtica, coherente y consistente.</p><a href="#contacto"><Arrow/>Conocer más</a></article>
      </div></section>
