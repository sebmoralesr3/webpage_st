...
function App() {
  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <div className="logo-marquee" aria-label="Clientes"><div className="logo-track">{[kreaLogo,zonedInLogo,stratosLogo,grupoLogo,electrosumigLogo,kreaLogo,zonedInLogo,stratosLogo,grupoLogo,electrosumigLogo].map((x,i)=><img src={x} alt="" width="195" height="52" key={i}/>)}</div></div>
      </div>
