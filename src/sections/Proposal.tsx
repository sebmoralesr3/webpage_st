    ...
    return (
        <section className="w-full px-10 sm:px-14 py-8 bg-light-gray rounded-3xl flex flex-row justify-between gap-5" id="proposal">
            <div className="w-full sm:w-1/2 self-center flex flex-col items-center sm:items-start justify-center h-full gap-6">
                ...
                <a href="https://calendly.com/dptotecnologico-solventechglobal/solventech" target="_blank" rel="noopener noreferrer" className="bg-gray-900 text-white font-semibold p-4 rounded-lg hover:bg-gray-700" onClick={() => trackEvent('schedule_click', { location: 'appointment_section' })}>
                    Contactanos
                </a>
            </div>
